import { ToolDef } from '@/types/pdf-tools';
import {
    FileImage,
    FileText,
    Globe,
...
export const TOOLS: ToolDef[] = [
...

    {
        id: 'word-to-pdf',
        title: 'Word to PDF',
        description: 'Word 문서(.docx)를 PDF로 변환하세요. (브라우저 직접 처리)',
        icon: 'FileType2',
    ...
    },
    {
        id: 'excel-to-pdf',
        title: 'Excel to PDF',
        description: 'Excel 스프레드시트를 PDF로 변환하세요. (브라우저 직접 처리)',
    ...
    },
    {
        ...
        description: 'PowerPoint 프레젠테이션을 PDF로 변환하세요. (브라우저 직접 처리)',
        icon: 'Presentation',
